...
const INDUSTRIES = [
  /* ── 1. Food & Beverage Manufacturing ─────────────── */
  {
    ...
    pressures: [
      { h: 'Demand volatility.',          body: "Consumer preferences shift faster than planning systems adapt. Premium SKUs, functional categories, and ready-meal growth all push demand in directions that traditional volume structures weren't built to absorb." },
      { h: 'Food safety compliance.',     body: 'SQF, BRC, FSMA, and customer audit requirements have raised the floor on process discipline across the entire operation. Food safety is a performance variable, not a quality department function.' },
      { h: 'Labor instability.',          body: 'Frontline turnover, supervisor capability gaps, and the cost of maintaining a trained production workforce make labor execution one of the most consequential variables in margin.' },
      { h: 'Changeover and SKU complexity.', body: "Contract and co-packed operations face changeover demands that most plants weren't engineered to handle efficiently. Lost changeover time is lost production capacity." },
      { h: 'Equipment reliability.',      body: 'Aging assets, mixed equipment fleets, and the cost of downtime on high-volume lines make asset performance a direct margin consideration — not a maintenance department category.' },
      { h: 'Supply chain stress.',        body: 'Single-source ingredients, packaging constraints, and transportation variability all introduce disruption that compounds through every production schedule.' },
    ],
    ...
    outcomesIntro: 'We measure impact using the operational metrics the business already tracks, and translate performance gains into financial terms your leadership team already reports. Engagements in food and beverage manufacturing move the following metrics:',
    ...
    subSegmentsClose: 'Our engagement approach is calibrated to the specific operating context of each sub-segment — the food safety architecture, the customer cadence, and the production pressures that define how work actually gets done.',
    whyBody: [
      "The food and beverage sector is well-served by firms that diagnose well. Assessment findings are rarely the gap. The gap is in building performance that stays built — across supervisors, shifts, and market conditions — after outside support is gone.",
      'Our senior practitioners work on the floor, across shifts, inside the management operating system that connects production, quality, food safety, and sanitation into one coherent performance picture. What we build sustains after the engagement closes.',
      "We take a performance-based commercial position. We get paid when we deliver the results we committed to. That reflects how seriously we stand behind the work.",
    ],
  },
