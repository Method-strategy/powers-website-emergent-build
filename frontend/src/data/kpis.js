...
export const kpiCategories = [
  ...
  },
  {
    ...
    kpis: [
      ...
      { name: 'Earnings Before Interest, Taxes, Depreciation, and Amortization (EBITDA)', def: 'A measure of operational profitability that strips out financing and accounting decisions a buyer might restructure post-close — widely used by private equity, lenders, and corporate development as the comparable benchmark across operations of different sizes and capital structures.', formula: 'EBITDA = Net income + interest + taxes + depreciation + amortization' },
