...
/* Workforce Capability — refactored onto the canonical "Operating
   Brief" shell. See OperationalDiscipline.jsx for the hero-image
   convention; drop the compressed JPG at
   /uploads/workforce-capability-hero-bg.jpg and uncomment the
   <img> + <div className="brief-page-hero-wash"> block when ready. */

export default function WorkforceCapability() {
  useEffect(() => { document.title = 'Workforce Capability Building for Manufacturing | POWERS'; }, []);
      ...
      <main style={{ paddingTop: 'var(--header-h, 112px)' }}>
        <section ref={heroRef} className="brief-page-hero">
          ...
          <img
            ...
            src="/uploads/workforce-capability-hero-bg.jpg"
            alt=""
            aria-hidden="true"
            loading="eager"
            decoding="async"
            data-testid="workforce-capability-hero-bg"
          />
