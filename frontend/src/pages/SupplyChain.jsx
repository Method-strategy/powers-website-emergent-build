...
const HTML = `<section style="background:#183a61;">
  <div style="max-width:1280px;margin:0 auto;width:100%;padding:120px 48px;min-height:600px;display:flex;flex-direction:column;justify-content:center;">
    ...
    <h1 style="font-size:clamp(36px,4.2vw,56px);font-weight:800;line-height:1.08;color:#ffffff;letter-spacing:-0.01em;font-family:inherit;max-width:920px;text-wrap:balance;">Supply Chain and Distribution Performance</h1>
  </div>
</section>`;
...
export default function SupplyChain() {
  return (
    <LegacyPage
      ...
      html={HTML}
      script={SCRIPT}
      title={`Supply Chain and Distribution Performance — POWERS Manufacturing Performance Consulting`}
      metaDescription={``}
    />
  );
}
