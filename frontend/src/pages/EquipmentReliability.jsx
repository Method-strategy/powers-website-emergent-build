...
/* Equipment Reliability — refactored onto the canonical "Operating
   Brief" shell. See OperationalDiscipline.jsx for the hero-image
   convention; drop the compressed JPG at
   /uploads/equipment-reliability-hero-bg.jpg and uncomment the
      ...
      <main style={{ paddingTop: 'var(--header-h, 112px)' }}>
        <section ref={heroRef} className="brief-page-hero">
          ...
          <img
            ...
            src="/uploads/equipment-reliability-hero-bg.jpg"
            alt=""
            aria-hidden="true"
            loading="eager"
            decoding="async"
            data-testid="equipment-reliability-hero-bg"
          />
