...
function PrintFooter({ page, total = 2 }) {
  return (
    <div className="pp-foot">
      ...
      <span className="pp-foot-page" style={{ marginLeft: 'auto' }}>{page} / {total}</span>
    </div>
  );
}
...
export default function CaseStudyPrintDoc({ data }) {
  ...
  // Short continued-title for page 2 masthead — first stat tile gives a good handle
  const primaryStat = statTiles[0] || {};
  const continuedTitle = primaryStat.label
    ? `${primaryStat.value} ${primaryStat.label.replace(/\n/g, ' ')}`
    : headlineResult;
    ...
    <div className="print-doc" id="print-doc">
      ...
      <div className="print-page">
        ...
        <div className="pp-hero">
          <div>
            <div className="pp-eyebrow">{disciplinesLine}</div>
        ...
        <div className="pp-rule-gold"></div>

        <div className="pp-section-eyebrow" style={{ marginTop: 24, marginBottom: 12 }}>
          Results at a Glance
        </div>

        <div className="pp-stats" style={{ marginTop: 0 }}>
          {statTiles.map((s, i) => (
        ...
        {situation ? (
          <div className="pp-section">
            <div className="pp-section-eyebrow">The Situation</div>
      ...
      <div className="print-page">
        <div className="pp-cont-mast">
          <div className="pp-cont-title">
            <span className="pp-cont-tag">Case Study &nbsp;|&nbsp; {industry} &nbsp;·&nbsp; </span>
            {continuedTitle}
          </div>
          <div className="pp-cont-label">Continued</div>
        </div>

        {diagnosis ? (
          <div className="pp-section">
            <div className="pp-section-eyebrow">The Diagnosis</div>
        ...
        {powersActions ? (
          <div className="pp-section">
            <div className="pp-section-eyebrow">What POWERS Did</div>
        ...
        {fullResult ? (
          <div className="pp-section">
            <div className="pp-section-eyebrow">The Full Result</div>
