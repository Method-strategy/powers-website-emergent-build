/* =============================================================
 * ✦ LOCKED V3 SNAPSHOT — DO NOT EDIT ✦
 * =============================================================
 * Frozen alongside /pages/HomeV3.jsx as the V3 archive (Feb 2026).
 * The mutable working copy lives at /components/PowersMetrics.jsx;
 * edit that one instead. This file exists so the /v3 route renders
 * visually identical to the locked release.
 * =============================================================
 *
